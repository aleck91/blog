...
const Ki = ({ className: e }) => (e || (e = "border-grey-200 dark:border-grey-800"), /* @__PURE__ */ d.jsx(Bl, { asChild: !0, decorative: !0, children: /* @__PURE__ */ d.jsx("hr", { className: e }) })), es = A("text-xs font-semibold tracking-normal"), ts = A(
  ...
  ReactComponent: hM,
  default: yM
}, Symbol.toStringTag, { value: "Module" })), bM = /* @__PURE__ */ Object.assign({ "../assets/icons/add.svg": $l, "../assets/icons/ai-tagging-spark.svg": eu, "../assets/icons/align-center.svg": ru, "../assets/icons/align-left.svg": su, "../assets/icons/angle-brackets.svg": lu, "../assets/icons/arrow-bottom-left.svg": gu, "../assets/icons/arrow-bottom-right.svg": mu, "../assets/icons/arrow-down.svg": pu, "../assets/icons/arrow-left.svg": fu, "../assets/icons/arrow-right.svg": Du, "../assets/icons/arrow-top-left.svg": Su, "../assets/icons/arrow-top-right.svg": Cu, "../assets/icons/arrow-up.svg": zu, "../assets/icons/at-sign.svg": Pu, "../assets/icons/baseline-chart.svg": Uu, "../assets/icons/bell.svg": Hu, "../assets/icons/bills.svg": Bu, "../assets/icons/book-open.svg": Vu, "../assets/icons/brackets.svg": $u, "../assets/icons/card-list.svg": e0, "../assets/icons/cardview.svg": r0, "../assets/icons/check-circle.svg": s0, "../assets/icons/check.svg": l0, "../assets/icons/chevron-down.svg": g0, "../assets/icons/chevron-left.svg": m0, "../assets/icons/chevron-right.svg": p0, "../assets/icons/chevron-up.svg": f0, "../assets/icons/close.svg": D0, "../assets/icons/column-layout.svg": S0, "../assets/icons/comment-fill.svg": C0, "../assets/icons/comment.svg": z0, "../assets/icons/crown.svg": P0, "../assets/icons/discount.svg": U0, "../assets/icons/download.svg": H0, "../assets/icons/duplicate.svg": B0, "../assets/icons/ellipsis.svg": V0, "../assets/icons/email-check.svg": $0, "../assets/icons/email.svg": ed, "../assets/icons/emailfield.svg": rd, "../assets/icons/error-fill.svg": sd, "../assets/icons/export.svg": ld, "../assets/icons/eyedropper.svg": gd, "../assets/icons/facebook.svg": md, "../assets/icons/finger-up.svg": pd, "../assets/icons/hamburger.svg": fd, "../assets/icons/heart-fill.svg": Dd, "../assets/icons/heart.svg": Sd, "../assets/icons/home.svg": Cd, "../assets/icons/hyperlink-circle.svg": zd, "../assets/icons/import.svg": Pd, "../assets/icons/info-fill.svg": Ud, "../assets/icons/integration.svg": Hd, "../assets/icons/key.svg": Bd, "../assets/icons/labs-flask.svg": Vd, "../assets/icons/language.svg": $d, "../assets/icons/laptop.svg": e1, "../assets/icons/layer.svg": r1, "../assets/icons/layout-headline.svg": s1, "../assets/icons/layout-module-1.svg": l1, "../assets/icons/like.svg": g1, "../assets/icons/link-broken.svg": m1, "../assets/icons/linkedin.svg": p1, "../assets/icons/listview.svg": f1, "../assets/icons/lock-locked.svg": D1, "../assets/icons/lock-unlocked.svg": S1, "../assets/icons/magnifying-glass.svg": C1, "../assets/icons/mail-block.svg": z1, "../assets/icons/megaphone.svg": P1, "../assets/icons/mobile.svg": U1, "../assets/icons/modules-3.svg": H1, "../assets/icons/money-bags.svg": B1, "../assets/icons/navigation.svg": V1, "../assets/icons/palette.svg": $1, "../assets/icons/pen.svg": eg, "../assets/icons/picture.svg": rg, "../assets/icons/piggybank.svg": sg, "../assets/icons/portal.svg": lg, "../assets/icons/question-circle.svg": gg, "../assets/icons/recepients.svg": mg, "../assets/icons/reload.svg": pg, "../assets/icons/share.svg": fg, "../assets/icons/single-user-block.svg": Dg, "../assets/icons/single-user-fill.svg": Vl, "../assets/icons/success-fill.svg": Sg, "../assets/icons/tags-block.svg": Cg, "../assets/icons/tags-check.svg": zg, "../assets/icons/textfield.svg": Pg, "../assets/icons/thumbs-down.svg": Ug, "../assets/icons/thumbs-up.svg": Hg, "../assets/icons/time-back.svg": Bg, "../assets/icons/trash.svg": Vg, "../assets/icons/twitter-x.svg": $g, "../assets/icons/unsplash-logo.svg": eM, "../assets/icons/upload.svg": rM, "../assets/icons/user-add.svg": sM, "../assets/icons/user-fill.svg": lM, "../assets/icons/user-page.svg": gM, "../assets/icons/user.svg": mM, "../assets/icons/warning.svg": pM, "../assets/icons/world-clock.svg": fM }), Be = ({ name: e, size: t = "md", colorClass: n = "", className: r = "" }) => {
...
}, vM = ({ size: e, color: t, delay: n, style: r }) => {
  ...
  const w = /* @__PURE__ */ d.jsxs(d.Fragment, { children: [
    ...
    N && /* @__PURE__ */ d.jsxs("div", { className: "absolute flex", children: [
      /* @__PURE__ */ d.jsx(vM, { color: p, size: t }),
...
var V = globalThis && globalThis.__assign || function() {
  ...
  return n;
}, Jn = Symbol("NiceModalId"), Rr = {}, mt = P.createContext(Rr), os = P.createContext(null), Ie = {}, Dt = {}, DM = 0, jt = function() {
  throw new Error("No dispatch method detected, did you embed your app with NiceModal.Provider?");
}, is = function() {
  return "_nice_modal_" + DM++;
}, ss = function(e, t) {
  var n, r, o;
...
function Hr(e, t) {
  var n = Nn(e);
  if (typeof e != "string" && !Ie[n] && pn(n, e), jt(xM(n, t)), !be[n]) {
...
var as = function(e) {
  var t = Nn(e);
  jt(LM(t)), delete be[t], delete st[t];
}, CM = function(e, t) {
  jt(SM(e, t));
};
function cs(e, t) {
...
var TM = function(e) {
  ...
  return !n || !r ? P.createElement(zM, null, t) : (jt = n, P.createElement(
    mt.Provider,
    { value: r },
    t,
    P.createElement(ls, null)
...
let RM = { data: "" }, HM = (e) => typeof window == "object" ? ((e ? e.querySelector("#_goober") : window._goober) || Object.assign((e || document.head).appendChild(document.createElement("style")), { innerHTML: " ", id: "_goober" })).firstChild : e || RM, GM = /(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g, YM = /\/\*[^]*?\*\/|  +/g, Eo = /\n+/g, ke = (e, t) => {
  let n = "", r = "", o = "";
  for (let i in e) {
    let s = e[i];
...
function hn(e) {
  ...
  return BM(n.unshift ? n.raw ? QM(n, [].slice.call(arguments, 1), t.p) : n.reduce((r, o) => Object.assign(r, o && o.call ? o(t.p) : o), {}) : n, HM(t.target), t.g, t.o, t.k);
}
let gs, cr, lr;
hn.bind({ g: 1 });
let De = hn.bind({ k: 1 });
...
var VM = (e) => typeof e == "function", tn = (e, t) => VM(e) ? e(t) : e, XM = (() => {
  let e = 0;
  return () => (++e).toString();
})(), Ms = (() => {
  let e;
...
})(), FM = 20, Vt = /* @__PURE__ */ new Map(), $M = 1e3, Zo = (e) => {
  if (Vt.has(e))
    return;
  let t = setTimeout(() => {
  ...
  switch (t.type) {
    case 0:
      return { ...e, toasts: [t.toast, ...e.toasts].slice(0, FM) };
    case 1:
      return t.toast.id && qM(t.toast.id), { ...e, toasts: e.toasts.map((i) => i.id === t.toast.id ? { ...i, ...t.toast } : i) };
    case 2:
      let { toast: n } = t;
...
}, KM = { blank: 4e3, error: 4e3, success: 2e3, loading: 1 / 0, custom: 4e3 }, eI = (e = {}) => {
  let [t, n] = Z(Ft);
  L(() => (Xt.push(n), () => {
    let o = Xt.indexOf(n);
    o > -1 && Xt.splice(o, 1);
  ...
  let r = t.toasts.map((o) => {
    var i, s;
    return { ...e, ...e[o.type], ...o, duration: o.duration || ((i = e[o.type]) == null ? void 0 : i.duration) || (e == null ? void 0 : e.duration) || KM[o.type], style: { ...e.style, ...(s = e[o.type]) == null ? void 0 : s.style, ...o.style } };
  });
  return { ...t, toasts: r };
}, tI = (e, t = "blank", n) => ({ createdAt: Date.now(), visible: !0, type: t, ariaProps: { role: "status", "aria-live": "polite" }, message: e, pauseDuration: 0, ...n, id: (n == null ? void 0 : n.id) || XM() }), At = (e) => (t, n) => {
  let r = tI(t, e, n);
...
var nI = (e, t) => {
  ...
  return { toasts: t, handlers: { updateHeight: nI, startPause: rI, endPause: r, calculateOffset: o } };
}, iI = De`
from {
...
`, pI = ({ toast: e }) => {
  ...
  return t !== void 0 ? typeof t == "string" ? c(NI, null, t) : t : n === "blank" ? null : c(mI, null, c(uI, { ...r }), n !== "loading" && c(II, null, n === "error" ? c(cI, { ...r }) : c(MI, { ...r })));
}, hI = (e) => `
...
`, fI = "0%{opacity:0;} 100%{opacity:1;}", bI = "0%{opacity:1;} 100%{opacity:0;}", vI = Re("div")`
  display: flex;
  align-items: center;
  background: #fff;
  color: #363636;
...
`, wI = (e, t) => {
  let n = e.includes("top") ? 1 : -1, [r, o] = Ms() ? [fI, bI] : [hI(n), yI(n)];
  return { animation: t ? `${De(r)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards` : `${De(o)} 0.4s forwards cubic-bezier(.06,.71,.55,1)` };
}, xI = Gi(({ toast: e, position: t, style: n, children: r }) => {
  let o = e.height ? wI(e.position || t || "top-center", e.visible) : { opacity: 0 }, i = c(pI, { toast: e }), s = c(DI, { ...e.ariaProps }, tn(e.message, e));
  return c(vI, { className: e.className, style: { ...o, ...n, ...e.style } }, typeof r == "function" ? r({ icon: i, message: s }) : c(mn, null, i, s));
});
JM(c);
var SI = ({ id: e, className: t, style: n, onHeightUpdate: r, children: o }) => {
  let i = T((s) => {
    if (s) {
      let a = () => {
...
`, Zt = 16, CI = ({ reverseOrder: e, position: t = "top-center", toastOptions: n, gutter: r, children: o, containerStyle: i, containerClassName: s }) => {
  let { toasts: a, handlers: l } = oI(n);
  return c("div", { style: { position: "fixed", zIndex: 9999, top: Zt, left: Zt, right: Zt, bottom: Zt, pointerEvents: "none", ...i }, className: s, onMouseEnter: l.startPause, onMouseLeave: l.endPause }, a.map((u) => {
    let g = u.position || t, M = l.calculateOffset(u, { reverseOrder: e, gutter: r, defaultPosition: t }), m = AI(g, M);
    return c(SI, { id: u.id, key: u.id, onHeightUpdate: l.updateHeight, className: u.visible ? LI : "", style: m }, u.type === "custom" ? tn(u.message, u) : o ? o(u) : c(xI, { toast: u, position: g }));
  }));
};
const Is = P.createContext({ isDirty: !1, setGlobalDirtyState: () => {
  ...
  darkMode: !1
}), zI = ({ fetchKoenigLexical: e, darkMode: t, children: n }) => {
  const [r, o] = Z(!1), i = (s) => {
    o(s);
  };
  return /* @__PURE__ */ d.jsx(kI.Provider, { value: { isAnyTextFieldFocused: r, setFocusState: i, fetchKoenigLexical: e, darkMode: t }, children: /* @__PURE__ */ d.jsxs(TI, { children: [
    /* @__PURE__ */ d.jsx(CI, {}),
...
function UI(e, t, n = !1) {
  return ve(e) ? PI(t) ? t.test(e) : ve(t) ? n ? e === t : e.includes(t) : !1 : !1;
}
function bn(e, t = [], n = !1) {
  return t.some((r) => UI(e, r, n));
}
function _I(e, t, n = 250, r, o, i, s) {
...
function ys(e, t = {}) {
  ...
  try {
    ...
    const a = " > ", l = a.length;
    let u;
    const g = Array.isArray(t) ? t : t.keyAttrs, M = !Array.isArray(t) && t.maxStringLength || HI;
    for (; n && i++ < r && (u = GI(n, g), !(u === "html" || i > 1 && s + o.length * l + u.length >= M)); )
...
function qI(e) {
  ...
  return ["protocol", "publicKey", "host", "projectId"].find((s) => e[s] ? !1 : (W.error(`Invalid Sentry Dsn: ${s} missing`), !0)) ? !1 : n.match(/^\d+$/) ? XI(r) ? t && isNaN(parseInt(t, 10)) ? (W.error(`Invalid Sentry Dsn: Invalid port ${t}`), !1) : !0 : (W.error(`Invalid Sentry Dsn: Invalid protocol ${r}`), !1) : (W.error(`Invalid Sentry Dsn: Invalid projectId ${n}`), !1);
}
function KI(e) {
  const t = typeof e == "string" ? $I(e) : fs(e);
  if (!(!t || !qI(t)))
    return t;
}
function q(e, t, n) {
...
function _o(e) {
  try {
    return ZI(e) ? ys(e) : Object.prototype.toString.call(e);
  } catch {
    return "<unknown>";
  }
}
...
function Yo(e, t = !1) {
  return (n) => {
    ...
    c2(n) || (e({ event: n, name: o, global: t }), Nr = n.type, pr = r ? r._sentryId : void 0), clearTimeout(Go), Go = ot.setTimeout(() => {
      pr = void 0, Nr = void 0;
    }, i2);
  };
}
...
function I2() {
  g2() && q(R, "fetch", function(e) {
    return function(...t) {
      const { method: n, url: r } = m2(t), o = {
        args: t,
        fetchData: {
          method: n,
          url: r
...
const v2 = R, bt = "__sentry_xhr_v3__";
function D2(e) {
  const t = "xhr";
  $e(t, e), qe(t, w2);
}
function w2() {
  ...
  q(e, "open", function(t) {
    return function(...n) {
      const r = Date.now(), o = ve(n[0]) ? n[0].toUpperCase() : void 0, i = x2(n[1]);
      if (!o || !i)
...
function ws(e, t = 3, n = 100 * 1024) {
  const r = A2(e, t);
  return k2(r) > n ? ws(e, t - 1, n) : r;
}
function fr(e, t, n = 1 / 0, r = 1 / 0, o = S2()) {
  const [i, s] = o;
  if (t == null || // this matches null and undefined -> eqeq not eqeqeq
  ["number", "boolean", "string"].includes(typeof t) && !OI(t))
    return t;
  const a = L2(e, t);
...
const z2 = ["fatal", "error", "warning", "log", "info", "debug"];
function E2(e) {
  return e === "warn" ? "warning" : z2.includes(e) ? e : "log";
}
const xs = 1e3;
function $r() {
  return Date.now() / xs;
...
function on(e) {
  return H2(e) ? e.getSpanJSON() : typeof e.toJSON == "function" ? e.toJSON() : {};
}
function H2(e) {
...
function Y2(e) {
  if (e)
    return B2(e) ? { captureContext: e } : J2(e) ? {
      captureContext: e
    } : e;
}
function B2(e) {
...
function Ls(e, t) {
  return Ke().captureException(e, Y2(t));
}
function Cs(e, t) {
...
function F2(e) {
  ...
  if (!t)
    return {};
  const n = X2(on(e).trace_id || "", t, V2()), r = ks(e);
  if (!r)
    return n;
  ...
  const a = on(r);
  return s && s !== "url" && (n.transaction = a.description), n.sampled = String(G2(r)), t.emit && t.emit("createDsc", n), n;
}
function $2(e, t) {
  const { fingerprint: n, span: r, breadcrumbs: o, sdkProcessingMetadata: i } = t;
  q2(e, t), r && t5(e, r), n5(e, n), K2(e, o), e5(e, i);
}
function q2(e, t) {
  const {
    extra: n,
...
function t5(e, t) {
  e.contexts = { trace: R2(t), ...e.contexts };
  const n = ks(t);
  if (n) {
    e.sdkProcessingMetadata = {
...
function n5(e, t) {
  e.fingerprint = e.fingerprint ? o2(e.fingerprint) : [], t && (e.fingerprint = e.fingerprint.concat(t)), e.fingerprint && !e.fingerprint.length && delete e.fingerprint;
}
const r5 = 100;
class Qe {
...
const o5 = "7.119.0", zs = parseFloat(o5), i5 = 100;
class Es {
...
`) : W.warn(
  ...
  endSession() {
    ...
    r && O2(r), this._sendSessionUpdate(), n.setSession();
  }
  /**
   * @inheritDoc
   ...
   */
  startSession(t) {
    const { scope: n, client: r } = this.getStackTop(), { release: o, environment: i = As } = r && r.getOptions() || {}, { userAgent: s } = R.navigator || {}, a = W2({
      release: o,
      environment: i,
      user: n.getUser(),
      ...s && { userAgent: s },
...
function s5(e = Dn()) {
  return (!a5(e) || // eslint-disable-next-line deprecation/deprecation
...
const u5 = [
  ...
  processEvent(t, n, r) {
    const o = r.getOptions(), i = M5(e, o);
    return I5(t, i) ? null : t;
  }
}), Ws = g5;
He(
  Ps,
...
function M5(e = {}, t = {}) {
  return {
    ...
    ignoreErrors: [
      ...e.ignoreErrors || [],
      ...t.ignoreErrors || [],
      ...e.disableErrorDefaults ? [] : u5
    ],
    ignoreTransactions: [
      ...e.ignoreTransactions || [],
      ...t.ignoreTransactions || [],
      ...e.disableTransactionDefaults ? [] : d5
    ],
    ignoreInternal: e.ignoreInternal !== void 0 ? e.ignoreInternal : !0
  };
}
function I5(e, t) {
  return t.ignoreInternal && y5(e) ? (ge && W.warn(`Event dropped due to being internal Sentry Error.
Event: ${ze(e)}`), !0) : m5(e, t.ignoreErrors) ? (ge && W.warn(
    `Event dropped due to being matched by \`ignoreErrors\` option.
Event: ${ze(e)}`
  ), !0) : j5(e, t.ignoreTransactions) ? (ge && W.warn(
    `Event dropped due to being matched by \`ignoreTransactions\` option.
Event: ${ze(e)}`
  ), !0) : N5(e, t.denyUrls) ? (ge && W.warn(
    `Event dropped due to being matched by \`denyUrls\` option.
Event: ${ze(
      e
    )}.
Url: ${sn(e)}`
  ), !0) : p5(e, t.allowUrls) ? !1 : (ge && W.warn(
...
function m5(e, t) {
  return e.type || !t || !t.length ? !1 : h5(e).some((n) => bn(n, t));
}
function j5(e, t) {
...
let Xo;
const Os = "FunctionToString", Fo = /* @__PURE__ */ new WeakMap(), b5 = () => ({
  name: Os,
  setupOnce() {
      ...
      values: [
        {
          ...
          value: A5(t, { isUnhandledRejection: r })
        }
      ]
    },
    extra: {
...
const w5 = /Minified React error #\d+;/i;
function x5(e) {
  if (e) {
    if (typeof e.framesToPop == "number")
      return e.framesToPop;
    if (w5.test(e.message))
      return 1;
  }
  return 0;
}
...
function Hs(e, t, n, r, o) {
  ...
  return Yr(t) ? Fn(e, t) : yn(t) || fn(t) ? (i = D5(e, t, n, o), jr(i, {
    synthetic: !0
...
function A5(e, { isUnhandledRejection: t }) {
  const n = e2(e), r = t ? "promise rejection" : "exception";
  return Br(e) ? `Event \`ErrorEvent\` captured as ${r} with message \`${e.message}\`` : fn(e) ? `Event \`${L5(e)}\` (type=${e.type}) captured as ${r}` : `Object captured as ${r} with keys: ${n}`;
}
function L5(e) {
  try {
    const t = Object.getPrototypeOf(e);
...
const Rt = 1024, Gs = "Breadcrumbs", C5 = (e = {}) => {
  const t = {
    console: !0,
    dom: !0,
    fetch: !0,
  ...
  return {
    ...
    // eslint-disable-line @typescript-eslint/no-empty-function
    setup(n) {
      t.console && n2(z5(n)), t.dom && s2(k5(n, t.dom)), t.xhr && D2(E5(n)), t.fetch && M2(Z5(n)), t.history && f2(P5(n)), t.sentry && n.on && n.on("beforeSendEvent", T5(n));
    }
  };
}, Ys = C5;
He(Gs, Ys);
...
function k5(e, t) {
  return function(r) {
    ...
    try {
      const u = r.event, g = W5(u) ? u.target : u;
      o = ys(g, { keyAttrs: s, maxStringLength: a }), i = BI(g);
    } catch {
      o = "<unknown>";
    }
    if (o.length === 0)
...
const Xs = "GlobalHandlers", H5 = (e = {}) => {
  ...
  return {
    ...
    setup(n) {
      t.onerror && (G5(n), ei("onerror")), t.onunhandledrejection && (Y5(n), ei("onunhandledrejection"));
    }
  };
}, Fs = H5;
He(
...
function G5(e) {
  j2((t) => {
    ...
    if (ae() !== e || _s())
      return;
    const { msg: o, url: i, line: s, column: a, error: l } = t, u = l === void 0 && ve(o) ? J5(o, i, s, a) : $s(
      Hs(n, l || o, void 0, r, !1),
      i,
      s,
      a
...
function Y5(e) {
  p2((t) => {
    ...
    if (ae() !== e || _s())
      return;
    const o = B5(t), i = Ns(o) ? Q5(o) : Hs(n, o, void 0, r, !0);
    i.level = "error", Cs(i, {
      originalException: o,
      mechanism: {
        handled: !1,
...
function $s(e, t, n, r) {
  const o = e.exception = e.exception || {}, i = o.values = o.values || [], s = i[0] = i[0] || {}, a = s.stacktrace = s.stacktrace || {}, l = a.frames = a.frames || [], u = isNaN(parseInt(r, 10)) ? void 0 : r, g = isNaN(parseInt(n, 10)) ? void 0 : n, M = ve(t) && t.length > 0 ? t : YI();
...
He(Ks, ea);
const X5 = "cause", F5 = 5, ta = "LinkedErrors", $5 = (e = {}) => {
  const t = e.limit || F5, n = e.key || X5;
  return {
    name: ta,
    // TODO v8: Remove this
    setupOnce() {
...
const q5 = [
  ...
  return {
    ...
    setupOnce() {
      t.setTimeout && q(X, "setTimeout", ti), t.setInterval && q(X, "setInterval", ti), t.requestAnimationFrame && q(X, "requestAnimationFrame", em), t.XMLHttpRequest && "XMLHttpRequest" in X && q(XMLHttpRequest.prototype, "send", tm);
      const n = t.eventTarget;
      n && (Array.isArray(n) ? n : q5).forEach(nm);
    }
  };
}, oa = K5;
He(
...
const ni = (e = {}, t = Ke()) => {
  ...
  i.async = !0, i.crossOrigin = "anonymous", i.src = l5(o, e), e.onLoad && (i.onload = e.onLoad);
  const { onClose: s } = e;
  if (s) {
    const l = (u) => {
...
O.isValidElementType = function(e) {
  return typeof e == "string" || typeof e == "function" || e === wn || e === Cn || e === Sn || e === xn || e === kn || e === rm || typeof e == "object" && e !== null && (e.$$typeof === En || e.$$typeof === zn || e.$$typeof === An || e.$$typeof === Ln || e.$$typeof === Tn || e.$$typeof === im || e.$$typeof === sm || e.$$typeof === am || e.$$typeof === om);
};
O.typeOf = ce;
ia.exports = O;
var cm = ia.exports, aa = cm, lm = {
  $$typeof: !0,
  render: !0,
  defaultProps: !0,
  displayName: !0,
...
ca[aa.ForwardRef] = lm;
ca[aa.Memo] = um;
const dm = typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__;
function gm(e) {
  const t = e.match(/^([^.]+)/);
  ...
  render() {
    ...
    if (r.error) {
      ...
      return typeof t == "function" ? o = t({
        ...
        eventId: r.eventId
      }) : o = t, ut(o) ? o : (t && dm && W.warn("fallback did not produce a valid ReactElement"), null);
    }
    return typeof n == "function" ? n() : n;
  }
}
const Im = ["top", "right", "bottom", "left"], We = Math.min, oe = Math.max, an = Math.round, Ht = Math.floor, Oe = (e) => ({
  x: e,
  y: e
}), mm = {
  left: "right",
  ...
  return e === void 0 && (e = {}), {
    ...
    async fn(t) {
      ...
      const {
        ...
        flipAlignment: j = !0,
        ...N
      } = we(e, t), p = xe(r), h = xe(s) === s, y = await (a.isRTL == null ? void 0 : a.isRTL(l.floating)), f = M || (h || !j ? [cn(s)] : pm(s));
      !M && I !== "none" && f.push(...ym(s, j, I, y));
...
const km = /* @__PURE__ */ Oe(0);
function Ma(e) {
  const t = se(e);
  return !ao() || !t.visualViewport ? km : {
...
function _m(e) {
  ...
  const s = [...n === "clippingAncestors" ? Um(t, this._c) : [].concat(n), r], a = s[0], l = s.reduce((u, g) => {
    const M = li(t, g, o);
...
function ja(e, t) {
  ...
  if (!he(e))
    return n;
  let r = ui(e, t);
  for (; r && Cm(r) && ue(r).position === "static"; )
    r = ui(r, t);
  return r && (Ue(r) === "html" || Ue(r) === "body" && ue(r).position === "static" && !so(r)) ? n : r || Tm(e) || n;
}
...
var lo = "Switch", [$m, fh] = _e(lo), [qm, Km] = $m(lo), Na = E(
  (e, t) => {
    const {
      __scopeSwitch: n,
      name: r,
    ...
    return /* @__PURE__ */ d.jsxs(qm, { scope: n, checked: p, disabled: a, children: [
      /* @__PURE__ */ d.jsx(
        Q.button,
        {
          type: "button",
...
var pa = "SwitchThumb", ha = E(
  (e, t) => {
    const { __scopeSwitch: n, ...r } = e, o = Km(pa, n);
    return /* @__PURE__ */ d.jsx(
      Q.span,
      {
  ...
  return /* @__PURE__ */ d.jsxs("div", { children: [
    /* @__PURE__ */ d.jsxs("div", { className: `group flex items-start gap-2 dark:text-white ${t === "rtl" && "justify-between"} ${a && "pb-2"}`, children: [
      /* @__PURE__ */ d.jsx(tj, { className: A(
        ...
        j,
        t === "rtl" && " order-2"
      ), defaultChecked: u, disabled: g, id: I, name: M, onCheckedChange: y, children: /* @__PURE__ */ d.jsx(nj, { className: A(
        N,
...
}, rj = ({ size: e = "md", buttons: t, link: n, linkWithPadding: r, clearBg: o = !0, outlineOnMobile: i, className: s }) => {
  let a = A(
...
var qn = "rovingFocusGroup.onEntryFocus", cj = { bubbles: !1, cancelable: !0 }, On = "RovingFocusGroup", [Sr, ba, lj] = ij(On), [uj, va] = _e(
  On,
  [lj]
), [dj, gj] = uj(On), Da = E(
  (e, t) => /* @__PURE__ */ d.jsx(Sr.Provider, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ d.jsx(Sr.Slot, { scope: e.__scopeRovingFocusGroup, children: /* @__PURE__ */ d.jsx(Mj, { ...e, ref: t }) }) })
);
Da.displayName = On;
var Mj = E((e, t) => {
  const {
    ...
    defaultProp: a,
    onChange: l
  }), [h, y] = Z(!1), f = sj(u), b = ba(n), v = C(!1), [D, w] = Z(0);
  return L(() => {
    const x = m.current;
    if (x)
  ...
  (e, t) => {
    const {
      ...
      tabStopId: i,
      ...s
    } = e, a = Wn(), l = i || a, u = gj(wa, n), g = u.currentTabStopId === l, M = ba(n), { onFocusableItemAdd: m, onFocusableItemRemove: I } = u;
    return L(() => {
      if (r)
        return m(), () => I();
          ...
          Q.span,
          {
            ...
            onKeyDown: H(e.onKeyDown, (j) => {
              ...
              if (j.target !== j.currentTarget)
                return;
              const N = jj(j, u.orientation, u.dir);
              if (N !== void 0) {
...
var pj = Da, hj = xa, uo = "Tabs", [yj, bh] = _e(uo, [
  va
]), Aa = va(), [fj, go] = yj(uo), bj = E(
  (e, t) => {
    const {
      __scopeTabs: n,
      value: r,
...
const xj = ({
  ...
  return /* @__PURE__ */ d.jsx(Dj, { children: /* @__PURE__ */ d.jsxs("div", { className: s, role: "tablist", children: [
...
var Mo = "Avatar", [Aj, vh] = _e(Mo), [Lj, Wa] = Aj(Mo), Oa = E(
  (e, t) => {
...
const Ar = ({ image: e, label: t, labelColor: n, bgColor: r, size: o, className: i }) => {
  ...
  return /* @__PURE__ */ d.jsxs(Tj, { className: `relative inline-flex select-none items-center justify-center overflow-hidden rounded-full align-middle ${s}`, children: [
    e ? /* @__PURE__ */ d.jsx(kj, { className: `absolute z-20 h-full w-full object-cover ${i && i}`, src: e }) : /* @__PURE__ */ d.jsx("span", { className: `${n && `text-${n}`} relative z-10 inline-flex h-full w-full items-center justify-center p-2 font-semibold ${i && i}`, style: r ? { backgroundColor: r } : {}, children: t }),
    /* @__PURE__ */ d.jsx(zj, { asChild: !0, children: /* @__PURE__ */ d.jsx(ns, { className: `${a} absolute z-0 h-full w-full text-grey-300` }) })
  ] });
};
function Ga(e) {
  const t = C(e);
...
function Zj(e, t = globalThis == null ? void 0 : globalThis.document) {
  const n = Ej(e);
  L(() => {
    const r = (o) => {
      o.key === "Escape" && n(o);
...
var Pj = "DismissableLayer", Lr = "dismissableLayer.update", Wj = "dismissableLayer.pointerDownOutside", Oj = "dismissableLayer.focusOutside", di, Ya = Ne({
  ...
  (e, t) => {
    const {
      ...
      onDismiss: a,
      ...l
    } = e, u = le(Ya), [g, M] = Z(null), m = (g == null ? void 0 : g.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), [, I] = Z({}), j = te(t, (w) => M(w)), N = Array.from(u.layers), [p] = [...u.layersWithOutsidePointerEventsDisabled].slice(-1), h = N.indexOf(p), y = g ? N.indexOf(g) : -1, f = u.layersWithOutsidePointerEventsDisabled.size > 0, b = y >= h, v = Rj((w) => {
...
Io.displayName = Pj;
var Uj = "DismissableLayerBranch", _j = E((e, t) => {
...
function Hj(e, t = globalThis == null ? void 0 : globalThis.document) {
  ...
  return L(() => {
    const o = (i) => {
      i.target && !r.current && Ba(Oj, n, { originalEvent: i }, {
        discrete: !1
      });
    };
...
var er = "focusScope.autoFocusOnMount", tr = "focusScope.autoFocusOnUnmount", mi = { bubbles: !1, cancelable: !0 }, Yj = "FocusScope", Qa = E((e, t) => {
  const {
    loop: n = !1,
    trapped: r = !1,
    onMountAutoFocus: o,
  ...
  L(() => {
    ...
    if (a) {
      ...
      if (!a.contains(N)) {
        ...
        a.addEventListener(er, u), a.dispatchEvent(h), h.defaultPrevented || (Bj(Fj(Ja(a)), { select: !0 }), document.activeElement === N && Le(a));
      }
      return () => {
  ...
  const j = T(
    (N) => {
      ...
      if (p && h) {
        const y = N.currentTarget, [f, b] = Qj(y);
...
function Le(e, { select: t = !1 } = {}) {
  if (e && e.focus) {
    const n = document.activeElement;
    e.focus({ preventScroll: !0 }), e !== n && Vj(e) && t && e.select();
  }
}
var Ni = Xj();
function Xj() {
...
function qj(e) {
  ...
  const [j, N] = Z(null), [p, h] = Z(null), y = T((z) => {
    ...
    U.current && (z.platform = U.current), Vm(D.current, w.current, z).then((ne) => {
      const re = {
        ...ne,
        isPositioned: !0
      };
...
var mo = "Popper", [Fa, Un] = _e(mo), [nN, $a] = Fa(mo), qa = (e) => {
...
ec.displayName = Ka;
var jo = "PopperContent", [rN, oN] = Fa(jo), tc = E(
  (e, t) => {
    ...
    const {
      ...
      padding: U,
      boundary: S.filter(sN),
      // with `strategy: 'fixed'`, this is the only way to get it to respect boundaries
      altBoundary: Y
    }, { refs: G, floatingStyles: $, placement: z, isPositioned: ne, middlewareData: re } = qj({
      // default to `fixed` strategy so users don't have to pick and we also avoid focus scroll issues
      strategy: "fixed",
      placement: k,
      whileElementsMounted: (...yt) => Jm(...yt, {
      ...
      middleware: [
        ...
        b && $j({ element: b, padding: a }),
        aN({ arrowWidth: w, arrowHeight: x }),
        m && Dm({ strategy: "referenceHidden", ..._ })
      ]
    }), [wo, Xc] = oc(z), kt = tN(j);
    Ze(() => {
      ne && (kt == null || kt());
...
var nc = "PopperArrow", iN = {
  ...
  const { __scopePopper: r, ...o } = t, i = oN(nc, r), s = iN[i.placedSide];
  return (
...
var ic = qa, No = ec, sc = tc, ac = rc, cN = function(e) {
  ...
  return o ? (r.push.apply(r, Array.from(o.querySelectorAll("[aria-live]"))), uN(r, o, n, "aria-hidden")) : function() {
    return null;
  };
}, pe = function() {
...
var Kt = "right-scroll-bar-position", en = "width-before-scroll-bar", MN = "with-scroll-bars-hidden", IN = "--removed-body-scroll-bar-size";
function mN(e, t) {
...
}, TN = gc(), lt = "data-scroll-locked", kN = function(e, t, n, r) {
...
`);
  ...
  return c(TN, { styles: kN(i, !t, o, n ? "" : "!important") });
}, Cr = !1;
if (typeof window < "u")
  try {
...
var nt = Cr ? { passive: !1 } : !1, ZN = function(e) {
  ...
  return e === "v" ? PN(t) : WN(t);
}, mc = function(e, t) {
  return e === "v" ? ON(t) : UN(t);
}, _N = function(e, t) {
  return e === "h" && t === "rtl" ? -1 : 1;
}, RN = function(e, t, n, r, o) {
  var i = _N(e, window.getComputedStyle(t).direction), s = i * r, a = n.target, l = t.contains(a), u = !1, g = s > 0, M = 0, m = 0;
  do {
...
function BN(e) {
  var t = C([]), n = C([0, 0]), r = C(), o = Z(YN++)[0], i = Z(gc)[0], s = C(e);
  L(function() {
    s.current = e;
  }, [e]), L(function() {
    if (e.inert) {
      document.body.classList.add("block-interactivity-".concat(o));
      var N = gN([e.lockRef.current], (e.shards || []).map(wi), !0).filter(Boolean);
  ...
  var a = T(function(N, p) {
    ...
    if (!r.current && "changedTouches" in N && (f || b) && (r.current = v), !v)
      return !0;
    var k = r.current || v;
    return RN(k, p, N, k === "h" ? f : b, !0);
  }, []), l = T(function(N) {
    var p = N;
    if (!(!rt.length || rt[rt.length - 1] !== i)) {
      var h = "deltaY" in p ? Di(p) : Qt(p), y = t.current.filter(function(v) {
        return v.name === p.type && (v.target === p.target || p.target === v.shadowParent) && HN(v.delta, h);
      })[0];
      if (y && y.should) {
    ...
    var f = { name: N, delta: p, target: h, should: y, shadowParent: QN(h) };
  ...
  return c(
    mn,
    null,
    j ? c(i, { styles: GN(o) }) : null,
    I ? c(EN, { gapMode: e.gapMode }) : null
  );
}
function QN(e) {
...
var jc = E(function(e, t) {
  return c(_n, pe({}, e, { ref: t, sideCar: JN }));
});
jc.classNames = _n.classNames;
const VN = jc;
var po = "Popover", [Nc, Dh] = _e(po, [
  Un
]), Tt = Un(), [XN, et] = Nc(po), pc = (e) => {
  const {
    __scopePopover: t,
    children: n,
    open: r,
...
bc.displayName = fc;
var FN = "PopoverPortal", [wh, $N] = Nc(FN, {
  forceMount: void 0
}), Mt = "PopoverContent", vc = E(
  (e, t) => {
    const n = $N(Mt, e.__scopePopover), { forceMount: r = n.forceMount, ...o } = e, i = et(Mt, e.__scopePopover);
    return /* @__PURE__ */ d.jsx(jn, { present: r || i.open, children: i.modal ? /* @__PURE__ */ d.jsx(qN, { ...o, ref: t }) : /* @__PURE__ */ d.jsx(KN, { ...o, ref: t }) });
  }
);
vc.displayName = Mt;
var qN = E(
  (e, t) => {
    ...
    return L(() => {
      ...
      if (s)
        return dN(s);
    }, []), /* @__PURE__ */ d.jsx(VN, { as: vt, allowPinchZoom: !0, children: /* @__PURE__ */ d.jsx(
      Dc,
      {
        ...e,
        ref: o,
...
const ap = ({
  ...
  return /* @__PURE__ */ d.jsxs(rp, { open: o, onOpenChange: i, children: [
    /* @__PURE__ */ d.jsx(op, { asChild: !0, children: /* @__PURE__ */ d.jsx(ip, { asChild: !0, children: e }) }),
    /* @__PURE__ */ d.jsx(sp, { align: n, className: "z-50 mt-2 origin-top-right rounded bg-white shadow-md ring-1 ring-[rgba(0,0,0,0.01)] focus:outline-none dark:bg-grey-900 dark:text-white", "data-testid": "popover-content", side: "bottom", onClick: s, children: t })
  ] });
};
function cp(e) {
...
function up(e) {
  var t, n;
  return e ? cp(e) ? e : lp(e) && (t = (n = e.ownerDocument) == null ? void 0 : n.defaultView) != null ? t : window : window;
}
var xi;
(function(e) {
  e.DragStart = "dragStart", e.DragMove = "dragMove", e.DragEnd = "dragEnd", e.DragCancel = "dragCancel", e.DragOver = "dragOver", e.RegisterDroppable = "registerDroppable", e.SetDroppableDisabled = "setDroppableDisabled", e.UnregisterDroppable = "unregisterDroppable";
})(xi || (xi = {}));
const dp = /* @__PURE__ */ Object.freeze({
  x: 0,
  y: 0
});
function gp(e) {
...
Lc.displayName = mp;
var jp = Lc, [Rn, xh] = _e("Tooltip", [
  Un
]), Hn = Un(), Cc = "TooltipProvider", Np = 700, zr = "tooltip.open", [pp, ho] = Rn(Cc), Tc = (e) => {
  const {
    __scopeTooltip: t,
    delayDuration: n = Np,
...
Tc.displayName = Cc;
var Gn = "Tooltip", [hp, Yn] = Rn(Gn), kc = (e) => {
  const {
    __scopeTooltip: t,
    children: n,
    open: r,
...
zc.displayName = Er;
var yp = "TooltipPortal", [Sh, fp] = Rn(yp, {
  forceMount: void 0
}), It = "TooltipContent", Ec = E(
  (e, t) => {
    const n = fp(It, e.__scopeTooltip), { forceMount: r = n.forceMount, side: o = "top", ...i } = e, s = Yn(It, e.__scopeTooltip);
    return /* @__PURE__ */ d.jsx(jn, { present: r || s.open, children: s.disableHoverableContent ? /* @__PURE__ */ d.jsx(Zc, { side: o, ...i, ref: t }) : /* @__PURE__ */ d.jsx(bp, { side: o, ...i, ref: t }) });
  }
), bp = E((e, t) => {
  const n = Yn(It, e.__scopeTooltip), r = ho(It, e.__scopeTooltip), o = C(null), i = te(t, o), [s, a] = Z(null), { trigger: l, onClose: u } = n, g = o.current, { onPointerInTransitChange: M } = r, m = T(() => {
    ...
    (j, N) => {
      const p = j.currentTarget, h = { x: j.clientX, y: j.clientY }, y = xp(h, p.getBoundingClientRect()), f = Sp(h, y), b = Ap(N.getBoundingClientRect()), v = Cp([...f, ...b]);
      a(v), M(!0);
    },
    [M]
  );
  return L(() => () => m(), [m]), L(() => {
    ...
    if (s) {
      const j = (N) => {
        const p = N.target, h = { x: N.clientX, y: N.clientY }, y = (l == null ? void 0 : l.contains(p)) || (g == null ? void 0 : g.contains(p)), f = !Lp(h, s);
        y ? m() : f && (m(), u());
      };
        ...
        children: /* @__PURE__ */ d.jsxs(
          sc,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ d.jsx(vp, { scope: n, isInside: !0, children: /* @__PURE__ */ d.jsx(jp, { id: l.contentId, role: "tooltip", children: o || r }) })
            ]
          }
        )
      }
...
const Pp = ({
  ...
  return o || (o = /* @__PURE__ */ d.jsx(ie, { className: "flex-row-reverse", icon: `${g === "asc" ? "arrow-up" : "arrow-down"}`, iconColorClass: "!w-3 !h-3 !mr-0 ml-1.5", label: `${(a = l.find((j) => j.selected)) == null ? void 0 : a.label}`, ...i })), /* @__PURE__ */ d.jsx(ap, { position: s, trigger: o, children: /* @__PURE__ */ d.jsxs("div", { className: "flex flex-col", children: [
...
}, Up = ({ content: e, size: t = "sm", children: n, containerClassName: r, tooltipClassName: o, origin: i = "center" }) => (r = A(
  "will-change-[opacity]",
  r
), o = A(
  ...
  t === "sm" && "text-xs",
  t === "md" && "text-sm"
), /* @__PURE__ */ d.jsx(kp, { delayDuration: 0, children: /* @__PURE__ */ d.jsxs(zp, { children: [
  /* @__PURE__ */ d.jsx(Ep, { className: r, onClick: (s) => s.preventDefault(), children: n }),
  /* @__PURE__ */ d.jsx(Zp, { align: i, className: o, sideOffset: 4, onPointerDownOutside: (s) => s.preventDefault(), children: e })
] }) })), _p = ({
  left: e,
  center: t,
  right: n,
...
}, Rp = () => /* @__PURE__ */ d.jsx(ie, { icon: "hamburger", iconColorClass: "text-black dark:text-white", size: "sm", link: !0, onClick: () => {
  alert("Clicked on hamburger");
} }), Hp = () => /* @__PURE__ */ d.jsx(ie, { icon: "magnifying-glass", iconColorClass: "dark:text-white text-black", size: "sm", link: !0, onClick: () => {
} }), Wc = ({
  fullBleedPage: e = !0,
...
}, Gp = ({ darkMode: e, fetchKoenigLexical: t, className: n, children: r, ...o }) => {
  const i = A(
    "admin-x-base",
    e && "dark",
    n
  );
  return /* @__PURE__ */ d.jsx("div", { className: i, ...o, children: /* @__PURE__ */ d.jsx(zI, { darkMode: e, fetchKoenigLexical: t, children: r }) });
};
class Bn {
  constructor() {
...
const Pr = new Xp(), Oi = ["online", "offline"];
class Fp extends Bn {
  constructor() {
    super(), this.setup = (t) => {
      if (!yo && window.addEventListener) {
...
function Yc(e) {
  ...
  const a = new Promise((p, h) => {
    ...
    Promise.resolve(p).then(m).catch((h) => {
      ...
      if (r)
        return;
      const b = (y = e.retry) != null ? y : 3, v = (f = e.retryDelay) != null ? f : $p, D = typeof v == "function" ? v(n, h) : v, w = b === !0 || typeof b == "number" && n < b || typeof b == "function" && b(n, h);
      if (t || !w) {
        I(h);
        return;
      }
...
class Bc {
  ...
  scheduleGc() {
    this.clearGcTimeout(), Bp(this.cacheTime) && (this.gcTimeout = setTimeout(() => {
      this.optionalRemove();
    }, this.cacheTime));
  }
  updateCacheTime(t) {
...
class Kp extends Bc {
  constructor(t) {
    super(), this.abortSignalConsumed = !1, this.defaultOptions = t.defaultOptions, this.setOptions(t.options), this.observers = [], this.cache = t.cache, this.logger = t.logger || vo, this.queryKey = t.queryKey, this.queryHash = t.queryHash, this.initialState = t.state || eh(this.options), this.state = this.initialState, this.scheduleGc();
  }
  get meta() {
  ...
  setData(t, n) {
    const r = Vp(this.state.data, t, this.options);
...
class nh extends Bc {
  constructor(t) {
    super(), this.defaultOptions = t.defaultOptions, this.mutationId = t.mutationId, this.mutationCache = t.mutationCache, this.logger = t.logger || vo, this.observers = [], this.state = t.state || rh(), this.setOptions(t.options), this.scheduleGc();
  }
  setOptions(t) {
    this.options = {
      ...this.defaultOptions,
    ...
    onFetch: (e) => {
      e.fetchFn = () => {
        ...
        if (!m.length)
          ...
          const D = typeof u < "u", w = D ? u : sh(e.options, m);
          b = f(m, D, w, !0);
        } else {
          j = [];
...
class ah {
  constructor(t = {}) {
    this.queryCache = t.queryCache || new th(), this.mutationCache = t.mutationCache || new oh(), this.logger = t.logger || vo, this.defaultOptions = t.defaultOptions || {}, this.queryDefaults = [], this.mutationDefaults = [], this.mountCount = 0;
  }
  mount() {
  ...
  setQueryData(t, n, r) {
    const o = this.queryCache.find(t), i = o == null ? void 0 : o.state.data, s = Yp(n, i);
    if (typeof s > "u")
      return;
  ...
  fetchInfiniteQuery(t, n, r) {
    const o = Jt(t, n, r);
    return o.behavior = ih(), this.fetchQuery(o);
  }
...
const _i = /* @__PURE__ */ Ne(void 0), ch = /* @__PURE__ */ Ne(!1);
function lh(e, t) {
...
const uh = ({
  ...
  const o = lh(n, r);
  return /* @__PURE__ */ c(ch.Provider, {
    value: !n && r
  }, /* @__PURE__ */ c(o.Provider, {
    value: e
  }, t));
}, Qc = window.adminXQueryClient || new ah({
  defaultOptions: {
    queries: {
...
function dh({ children: e, ...t }) {
  return /* @__PURE__ */ d.jsx(no, { children: /* @__PURE__ */ d.jsx(uh, { client: Qc, children: /* @__PURE__ */ d.jsx(Jc.Provider, { value: t, children: e }) }) });
}
const gh = () => le(Jc), Vc = Ne({
  route: "",
  updateRoute: () => {
  },
  loadingModal: !1,
...
const Ih = (e, t, n, r) => {
  ...
  o = o.substring(1);
  const i = `${window.location.protocol}//${window.location.hostname}`, s = new URL(o, i), a = Mh(e, s.pathname), l = s.searchParams;
  if (a && r && n) {
  ...
  if (r)
    return r.groups || {};
}, mh = ({ basePath: e, modals: t, children: n }) => {
  const { externalNavigate: r } = gh(), [o, i] = Z(void 0), [s, a] = Z(!1), [l] = Z(new EventTarget()), u = T((g) => {
  ...
  return L(() => {
    ...
    const g = () => {
      i((M) => {
        const { pathName: m, modal: I, changingModal: j } = Ih(e, M, t == null ? void 0 : t.load, t == null ? void 0 : t.paths);
...
const jh = () => {
  ...
  const { updateRoute: e } = Do(), [t, n] = Z("list"), r = [
    /* @__PURE__ */ d.jsx(ie, { label: "Filter", onClick: () => {
      Op({ message: "Were you really expecting a filter? 😛" });
    } }),
    /* @__PURE__ */ d.jsx(
      Pp,
      {
    ...
    /* @__PURE__ */ d.jsx(Up, { content: "Search members", children: /* @__PURE__ */ d.jsx(ie, { icon: "magnifying-glass", size: "sm", onClick: () => {
      alert("Clicked search");
    } }) }),
    /* @__PURE__ */ d.jsx(rj, { buttons: [
      {
        icon: "listview",
        size: "sm",
  ...
  const { route: e } = Do();
  return e === "detail" ? /* @__PURE__ */ d.jsx(jh, {}) : /* @__PURE__ */ d.jsx(Nh, {});
}, hh = {
  paths: {
    "demo-modal": "DemoModal"
  },
  load: async () => import("./modals-7ad4170c.mjs")
}, Ah = ({ framework: e, designSystem: t }) => /* @__PURE__ */ d.jsx(dh, { ...e, children: /* @__PURE__ */ d.jsx(mh, { basePath: "demo-x", modals: hh, children: /* @__PURE__ */ d.jsx(Gp, { className: "admin-x-demo", ...t, children: /* @__PURE__ */ d.jsx(ph, {}) }) }) });
export {
  Ah as A,
  ie as B,
  B as H,
...
//# sourceMappingURL=index-b29b8d8c.mjs.map
